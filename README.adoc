...
=== golangci-lint
https://github.com/golangci/golangci-lint/cmd/golangci-lint[golangci-lint] is used to validate the code I write. see the link:.golangci.yml[golangci-lint config file]
